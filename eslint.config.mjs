...
// frontend/web's Next.js plugin rules).
...
export default tseslint.config(
  ...
  },
  {
    rules: {
      ...
      // CAUTION (backend/api specifically): running `eslint --fix` will happily
      ...
      // Phase 0 — after running --fix in backend/api, grep for `@Body()`,
