...
/**
 * apps/web's own env schema — deliberately NOT importing `loadEnv` from
 ...
 * `.env`. This mirrors only the vars apps/web actually reads (all sourced
...
const webEnvSchema = z.object({
  ...
  // Server-to-server calls (Route Handlers/Server Actions calling apps/api)
