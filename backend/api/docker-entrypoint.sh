#!/bin/sh
# =============================================================================
# backend/api container entrypoint.
#
...
# — requiring them from backend/api's compiled (tsc) code is a require() of a
...
# transpiled on the fly. This is NOT used for backend/api's own code (which
...
#
# tsx is a devDependency of packages/db (not backend/api itself, and not
...
exec node -r "$TSX_HOOK" backend/api/dist/main.js
